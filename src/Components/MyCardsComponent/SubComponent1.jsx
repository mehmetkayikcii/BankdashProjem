...
const SubComponent1 = () => {
  return (
    <div className="bg-gradient-to-r from-blue-700 via-blue-800 to-blue-900 text-white rounded-2xl ">
      ...
      <div
        ...
        className="flex justify-between  bg-gradient-to-b from-blue-700 via-blue-800 to-blue-900  rounded-br-2xl rounded-bl-2xl p-4"
      >
        <div>
