...
const SubComponent2 = () => {
  return (
    <div className="bg-white text-blue-900 rounded-2xl border border-gray-300">
      ...
      <div
        ...
        className="flex justify-between    p-3 rounded-br-2xl rounded-bl-2xl border border-slate-300 bg-white"
      >
        <div>
          <p className=" text-2xl">3778 **** **** 1234</p>
        </div>
        <div>
        <svg xmlns="http://www.w3.org/2000/svg" width="2.6em" height="2.6em" viewBox="0 0 24 24"><g fill="#7a7171" fillRule="evenodd"><circle cx={7} cy={12} r={7}></circle><circle cx={17} cy={12} r={7} fillOpacity={0.8}></circle></g></svg>
        </div>
      </div>
    </div>
  );
